...
const MobileFilter = ( {openFilter, setOpenFilter ,search, setSearch, brand, setBrand, priceRange, setPriceRange, setCategory, category,handleCategoryChange, handleBrandChange}) => {
